      ...
      <div className="container mx-auto px-4 py-14">
        <div className="grid grid-cols-1 gap-10 md:grid-cols-4">
          ...
          <div>
            ...
            <ul className="space-y-3 text-gray-300">
              <li className="flex items-center gap-2"><Phone className="h-5 w-5 text-[#9AE6B4]" /> (51) 3667-1096</li>
              <li className="flex items-center gap-2"><Phone className="h-5 w-5 text-[#9AE6B4]" /> (51) 98011-1096</li>
              <li className="flex items-center gap-2"><Mail className="h-5 w-5 text-[#9AE6B4]" /> <a href="mailto:atendimento@ascassessoria.com.br" className="hover:text-white">atendimento@ascassessoria.com.br</a></li>
