        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            ...
            <motion.div variants={fadeInUp} className="bg-white rounded-3xl shadow-2xl p-6 sm:p-8 md:p-16 mb-16 relative overflow-hidden">
              ...
              <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-6">Quem Somos</h2>

              <p className="text-base sm:text-lg md:text-xl text-gray-700 leading-relaxed mb-6">
                A <span className="font-bold text-brand-strong">ASC Assessoria Contábil</span> é uma empresa com
                <span className="font-bold text-brand-strong"> experiência consolidada em contabilidade e assessoria jurídica</span>,
                atuando desde 2014 no suporte estratégico a empresas de diferentes portes e segmentos em todo o Brasil.
              </p>

              <p className="text-base sm:text-lg md:text-xl text-gray-700 leading-relaxed mb-6">
                Nosso diferencial está em um <span className="font-bold text-brand-strong">atendimento ágil, desburocratizado e personalizado</span>,
                com uma comunicação clara que aproxima o universo contábil da realidade de cada cliente.
              </p>

              <p className="text-base sm:text-lg md:text-xl text-gray-700 leading-relaxed mb-6">
                Atuamos com <span className="font-bold text-brand-strong">ética, sigilo e total transparência</span> nas informações,
              ...
              <p className="text-base sm:text-lg md:text-xl text-gray-700 leading-relaxed">
                ...
                <span className="font-bold text-brand-strong"> soluções completas em contabilidade, fiscal, pessoal, societário e jurídico</span>,
            ...
            <motion.div variants={fadeInUp} className="mb-16">
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-center text-gray-900 mb-4">
                Nossos <span className="text-brand-strong">Valores</span>
              </h2>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                {values.map((value, index) => (
                  ...
                  >
                    ...
                    <value.icon className="w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 text-brand-strong mb-4 group-hover:scale-110 transition-transform" />
            ...
            <motion.div variants={fadeInUp} className="bg-gradient-to-br from-brand-strong to-brand-deep rounded-3xl shadow-2xl p-6 sm:p-8 md:p-16 text-white text-center relative overflow-hidden">
              ...
              <div className="relative z-10">
                <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-6">O que entregamos</h2>
                ...
                <div className="inline-block px-6 py-3 sm:px-8 bg-white/20 rounded-full backdrop-blur-sm">
                  <p className="text-sm sm:text-base md:text-lg font-semibold">Desde 2014 construindo parcerias de confiança</p>
                </div>
              </div>
            </motion.div>
          </motion.div>
