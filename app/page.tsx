  ...
  return (
    <div className="min-h-screen bg-white overflow-x-hidden">
      <motion.header
        ...
        style={{ 
          backgroundColor: pathname === '/' ? headerBackground : 'rgba(255, 255, 255, 0.95)',
          boxShadow: pathname === '/' ? headerShadow : '0 4px 20px rgba(0, 0, 0, 0.1)'
        }}
      >
                  ...
                  <a href="#contato" aria-label="Fale conosco">
                    ...
                    >
                      ...
                      <motion.div
                        className="ml-2"
                        animate={{ x: [0, 5, 0] }}
                        transition={{ duration: 1.5, repeat: Infinity, delay: 3.0 }}
                      >
